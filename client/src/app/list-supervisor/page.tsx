    ...
    <div className='w-full min-h-screen bg-gray-100 p-6'>
      <div className='w-full max-w-7xl mx-auto bg-white p-6 rounded-md shadow-md border border-gray-300'>
        ...
        <div className='mt-4 flex items-center space-x-2 w-full'>
          ...
          <input type='text' className='border p-2 rounded-md flex-1' placeholder='FE Email or Name' />
          <Button className='bg-blue-400 text-white px-4 py-2 rounded-md hover:bg-blue-500'>Search</Button>
        </div>
              ...
              {[
                ...
                <tr key={index} className='border-t hover:bg-gray-50'>
                  ...
                  <td className='border p-3 text-center'>
                    <Button className='bg-blue-500 text-white px-4 py-1 rounded-md hover:bg-blue-600'>View</Button>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className='mt-6 flex justify-center space-x-2'>
          <Button className='text-gray-500 border border-gray-300 px-4 py-2 rounded-md bg-transparent'>First</Button>
          <Button className='bg-blue-500 text-white px-4 py-2 rounded-md'>1</Button>
          <Button className='border border-gray-300 px-4 py-2 rounded-md'>2</Button>
          <Button className='text-gray-500 border border-gray-300 px-4 py-2 rounded-md bg-transparent'>Last</Button>
        </div>
      </div>
    </div>
  )
