      ...
      <div className='space-y-6'>
        ...
        <div>
          ...
          <p className='text-gray-700'>
            The system helps manage the process of registering and implementing graduation thesis topics. It includes
            functions such as topic registration, assignment of supervising lecturers, progress tracking, and result
            evaluation.
          </p>
        </div>
