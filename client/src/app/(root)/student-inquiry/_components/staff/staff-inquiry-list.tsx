...
import { FaAngleRight, FaFilterCircleXmark } from 'react-icons/fa6'
import {
  Pagination,
  PaginationContent,
  PaginationItem,
...
const StaffInquiryList = () => {
  const { staffGetListStudentInquiries } = useStudentInquiry()
  ...
  const fetchInquiries = async () => {
    try {
      setLoading(true)
      const response = await staffGetListStudentInquiries({
        page,
        limit,
                    ...
                    <TableRow key={inquiry._id}>
                      ...
                      <TableCell className='flex gap-2'>
                        <Button variant='outline' size='sm'>
                          <Link href={`/student-inquiry/${inquiry._id}/answer`}>Answer</Link>
                        </Button>
                        <Button variant='outline' size='sm'>
